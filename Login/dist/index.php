...
<div class="container" id="container">
	<div class="form-container sign-up-container">
		<form action="controlLog.php">
			...
			<input type="email" placeholder="Email" name="txtEmail_R"/>
			<input type="password" placeholder="Contraseña" name="txtPass_R"/>
			<button id = "btnRegistrar" name = "btnRegistrar">Registrarse</button>
		</form>
	</div>
	<div class="form-container sign-in-container">
		<form action="controlLog.php" method = "POST">
			<h1>Inicia Sesión</h1>
			<div class="social-container">
				
			</div>
			<span>O usa tu cuenta personal</span>
			<input type="email" placeholder="Email" name="txtEmail_I" />
			<input type="password" placeholder="Contraseña" name="txtPass_I"/>
